...
public interface Fraction extends Comparable<Fraction> {
    ...
    /**
     * Returns a new <pre>Fraction</pre> that is the quotient of dividing this by the parameter
     * (a/b) / (c/d) is (a*d)/(b*c)
     *
     ...
     * numerator and d is the <em>denominator</em>.
     ...
     *
     * @return the string representation for the fraction
     */
    @Override
